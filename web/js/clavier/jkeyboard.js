...
; (function ($, window, document, undefined) {
    ...
    var layouts = {
        azeri: [
			...
			['a', 'z', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p'],
            ['q', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm'],
            ['@','w', 'x', 'c', 'v', 'b', 'n', '.com','.fr','backspace'],
        ],
        english: [
            ['q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p',],
            ['a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l',],
            ['numeric_switch', 'z', 'x', 'c', 'v', 'b', 'n', 'm', 'backspace'],
            ['space']
        ],
        german: [
    ...
    Plugin.prototype = {
        ...
        createKeyboard: function (layout) {
            ...
            $(this.element).html('').append('<div class="jkeyboard-close"><a class="btn btn-close"><img height="27"  src="../../../web/images/grille/fiches/bt_close.png" /></a></div>');
            $(this.element).append(keyboard_container);
        ...
        events: function () {
            var letters = $(this.element).find('.letter'),
                ...
                close_key = $(this.element).find('.jkeyboard-close'),
                me = this,
            ...
            letters.on('click', function () {
                ...
                if(me.settings.eventClick){
                    me.settings.eventClick();
                }
            });
