...
(function($){
        ...
        'layout': [
            ...
            [
                [
                      ...
                      ['Annuler', '27', 27, 3, true], ['Space', '32', 32, 12, false], ['Supp', '46', 46, 3, false], ['RetArr', '8', 8, 3, false]
                ],
                [
    ...
    $.fn.updateContentEle = function(targetInput,ele_id){
        activeInput.htmlElem = $(targetInput);
        activeInput.ele_id = ele_id;
    };
    ...
    function activateKeypad(targetInput){
        if($('div.jQKeyboardContainer_'+ activeInput.ele_id).length === 0)
        {
    ...
    function createKeypadContainer(){
        ...
        container.setAttribute('class', 'jQKeyboardContainer_'+ activeInput.ele_id);
        container.setAttribute('id', 'jQKeyboardContainer_'+ activeInput.ele_id);
        container.setAttribute('name', 'keyboardContainer' + activeInput.keyboardType);
        console.log(container);
        $('#virtualKeyboard_'+ activeInput.ele_id).append(container);
    }
    ...
    function createKeypad(set){
        $('#jQKeyboardContainer_'+ activeInput.ele_id).empty();
        ...
        for(var i = 0; i < layout.length; i++){
            ...
            if(layout[i][4]){
                ...
                $('#jQKeyboardContainer_'+ activeInput.ele_id).append(row);
            }
    ...
    function removeKeypad(){
        $('#jQKeyboardContainer_'+ activeInput.ele_id).remove();
